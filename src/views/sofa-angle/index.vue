  ...
  data () {
    return {
      ...
      },
      {
        ...
        type: "Диваны угловые" ,
        size: "1740х1120х940",
        description:"Спальное место 1950х1400см. Механизм пантограф. Преимущество этого дивана в огромном ящике под постельное белье и механизме пантограф. Угол дивана не меняется." ,
        prise:"от 54 650 ₽",
      },
      {
        // здесь должен быть слайдер
        ...
        type: "Диваны угловые" ,
        size: "1970х850х920",
        description:"Cпальное место 1500x2000. Механизм раскралыдывания пантограф" ,
        prise:" от 39 100 ₽",
      },
      {
        // здесь должен быть слайдер
        ...
        type: "Диваны угловые" ,
        size: "2900х1050х1500",
        description:"Четырехместная. Механизм тик-так, пружинный блок, угол меняется, у подушек съемные чехлы, подлокотники МДФ. При транспортировке легко расскладывается и складывается. У него может быть крeсло." ,
        prise:" от 48 000 ₽",
      },
    ]
    }
